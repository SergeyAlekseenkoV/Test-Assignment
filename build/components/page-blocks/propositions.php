            ...
            <div class="row py-2 ml-0 pl-0 mr-0 pr-0">
                        ...
                        <nav class="accordion" id="accordionProp">
                            ...
                            <div class="card bg-transparent">
                                <div class="card-header p-0 bg-dark border-top" id="first-item">
                                    <button
                                        class="btn bg-transparent btn-block text-left d-flex flex-row justify-content-between justify-content-sm-center justify-content-lg-between align-items-center  text-white text-uppercase"
                                ...
                                <div id="collapseOne" class="collapse bg-transparent" aria-labelledby="first-item"
                                    ...
                                    <ul class="card-body list-group p-0 text-white">
                                        ...
                                        <li class="list-group-item bg-transparent border-top p-2">
                                            <p class="mb-0 small">&bull;&nbsp; Найдієвіші пропозиції (ідеї) будуть
                                                відзначені
                                                грошовими винагородами у вигляді премій</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="card bg-transparent">
                                ...
                                <div id="collapseTwo" class="collapse bg-transparent" aria-labelledby="second-item"
                                    data-parent="#accordionProp">
                                    <ul class="card-body list-group p-0 text-white">
                                        <li class="list-group-item bg-transparent p-2">
                ...
                <div class="col-sm-12 col-lg-10 px-0 pl-md-0 pl-lg-1 py-0 pr-lg-0">
                    <aside class="mt-2 mt-lg-0 bg-info border border-primary rounded shadow">
                        ...
                        <form action="" method="post" id="sendingForm">
                            <fieldset class="form-row m-1 p-1 p-sm-2 p-md-3 p-lg-4 p-xl-5 bg_muted border rounded">
                                <div class="form-group col-md-12">
                                    <label for="propname" class="text-uppercase font-weight-bold">Назва
                                        пропозиції</label>
                                    <input type="text" class="form-control border border-primary shadow text_color"
                                        placeholder="Назва пропозиції" id="propname" required>
                                </div>
                                ...
                                <div class="form-group col-8 col-md-3 bg-light pb-1">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text border border-primary shadow text_color"
                                                id="tabnumprepend">№</span>
                                        </div>
                                        <input type="text" class="form-control border border-primary text_color"
                                            id="tabnumber" aria-label="tabnumber" aria-describedby="tabnumprepend"
                                            readonly required>
                                    </div>
                                </div>
                                <div class="form-group col-md-9 bg-light pb-1">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border border-primary text_color"
                                            id="authorname" placeholder="П.І.Б автора" aria-label="authorname"
                                            aria-describedby="usericonprepend" readonly required>
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="inputAddress">Цех, професія</label>
                                    <input type="text" class="form-control border border-primary shadow text_color"
                                        id="inputAddress" placeholder="Цех, професія" required>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="emailaddress"
                                            class="form-control border-primary shadow bg-light" placeholder="email"
                                            id="emailaddress" aria-describedby="emailaddress" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea class="w-100 rounded shadow" id="problemDescr"
                                        placeholder=" Суть проблеми" name="problemDescr" rows="5" cols="49"
                                        required></textarea>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group col-12">
                                    <label for="solutionDescr" class="text_color">Запропоновані рішення</label>
                                    <textarea class="w-100 rounded shadow" id="solutionDescr"
                                        placeholder=" Шляхи вирішення проблеми" name="solutionDescr" rows="5" cols="49"
                                        required></textarea>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group col-md-10 col-md-9">
                                    <label for="coauthors" class="text_color">Співавтори</label>
                                    <textarea class="w-100 rounded shadow" id="coauthors"
                                        placeholder=" П.І.Б співавторів, якщо такі є &nbsp;/&nbsp;Необов'язкове поле"
                                        name="coauthors" rows="3" cols="49"></textarea>
                                </div>
                                <div class="col-md-10 mb-3 prop_selection">
                                    <label for="propDirection">Напрямок пропозиції</label>
                                    <select class="custom-select border-primary rounded shadow text_color"
                                        id="propDirection" required>
                                ...
                                <div class="form-group col-md-10 col-md-9">
                                    ...
                                    <textarea class="w-100 rounded shadow" id="influenceIndicator"
                                        placeholder=" Показники &nbsp;/&nbsp;Необов'язкове поле" name="coauthors"
                                        rows="3" cols="49"></textarea>
                                </div>
                                ...
                                <button type="submit"
                                    class="btn btn-lg btn-primary w-50 mx-1 mt-4 py-2 py-md-3 shadow">Подати
                                    пропозицію</button>
                            </fieldset>
                        </form>
