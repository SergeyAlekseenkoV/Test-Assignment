        ...
        <div class="container pt-2 pb-2 pb-lg-3 px-sm-0 px-md-3 px-lg-3 px-xl-3">
            <div class="d-flex justify-content-between align-items-baseline mt-3 mt-md-3 mt-lg-3 mt-xl-4">
                <h3 class="d-md-none d-lg-block pt-sm-2 pt-lg-3 text-left text-uppercase text_color wow slideInLeft"
                    data-animation="slideInLeft">Оголошення</h3>
                <h3
            ...
            <div class="row pb-sm-1 ml-0 px-0 mr-0">
                ...
                <aside
                    ...
                    <div id="announcement-description" class="row m-0 p-1 border border-primary rounded shadow bg_info_through">
                        <!-- card-item -->
                        <div class="card shadow">
                            <div class="row mx-1">
                                <div class="col-12 mx-auto px-0 pt-1">
                                    <div class="card-block p-1">
                                        <img src="../build/img/pexels-08.png" alt="фото" class="img-fluid obj-fit height-210 position-relative mr-md-2 float_left">
