        ...
        <div class="container pt-2 pb-2 pb-lg-3 px-sm-0 px-md-3 px-lg-3 px-xl-3">
            ...
            <div class="row pb-sm-1 ml-0 px-0 mr-0 mb-lg-5">
                ...
                <aside class="col-sm-12 col-lg-10 px-0 px-sm-0 pl-md-0 pl-lg-1 py-3 py-lg-0">
                    <div id="study-part-medical" class="row mx-0 border border-primary rounded bg_light_through">
                        <!-- heading -->
                        <div class="col-12 mx-0 px-0 text-center">
                            <h2
                                ...
                                Навчання - База ідей</h2>
                        </div>
                        <div class="col-12 mx-0 px-0 text-center">
                            <h3
                                class="d-flex flex-row justify-content-center align-items-center flex-wrap text-uppercase px-1 py-2 mx-1 my-1">
                                Курс медична допомога</h3>
                        </div>
                        <!-- study-list -->
                        <div class="col-12 col-md-6 col-lg-4 p-1 mx-0">
                            <a href="#"
                                class="btn btn-light shadow py-3 w-100 text-uppercase text_color">
                        ...
                        <div class="col-12 col-lg-6 p-1 mx-0">
                            <a href="#"
                                class="btn btn-light shadow py-3 w-100 text-uppercase text_color">
