                            ...
                            <div class="card bg-transparent border mx-1 shadow">
                                ...
                                <div class="card-body p-2 bg_info_through">
                                    ...
                                    <div class="row mx-0 gallery" id="gallery">
                                        ...
                                        <!-- button-close -->
                                            <button class="btn btn-transparent my-3 p-0 text_color" id="hidePhotos">
                                                <i class="far fa-times-circle fa-2x"></i></button>
                                        </div>
                                    </div>
                                    <p class="lead px-2 card-text text_color">Some quick example text to build on the card
                                                    ...
                                                    <figure class="modal-body position-relative height-modal-img mb-0">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            <span aria-hidden="true"
                                                                class="btn btn-transparent mb-4 p-0 text-info">
                                                                <i class="far fa-times-circle fa-4x"></i></span>
                                                        </button>
                                                    </figure>
                                                </div>
                                            </div>
