...
<title>Трудове змагання</title>
</head>

<body id="main">
    <?php include_once "menu.php"; ?>
    <!-- main-section-->
    <section class="mt-0 pt-3 pb-lg-5 competition_list">
        <div class="container pt-2 pb-2 pb-lg-3 px-sm-0 px-md-3 px-lg-3 px-xl-3">
            <div class="d-flex justify-content-between align-items-baseline mt-3 mt-md-3 mt-lg-3 mt-xl-4">
                <h3 class="d-md-none d-lg-block pt-sm-2 pt-lg-3 text-left text-uppercase text_color wow slideInLeft"
                    data-animation="slideInLeft">Трудове змагання</h3>
                <h3
                ...
                <aside id="competition-list"
                    ...
                    <div class="row m-0 p-0 border border-primary rounded shadow winner_hover">
                        ...
                        <div class="col-12 col-lg-6 mt-1 px-1 left_lg_list">
                            ...
                            <!-- enterprise competition among departments-->
                            <div class="row">
                                <div class="col-12">
                        ...
                        <div class="col-12 col-lg-6 mt-1 px-1 right_lg_list">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex flex-row justify-content-around text-center">
                                        <h5
                                            class="d-flex flex-column justify-content-center bg-secondary rounded shadow w-100 font-weight-bold type_title">
                                            Робочий допоміжного цеху</h5>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="d-flex flex-row justify-content-around text-center">
