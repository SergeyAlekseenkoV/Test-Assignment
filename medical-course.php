    ...
    <section class="mt-0 pt-3">
        <div class="container pt-2 pb-2 pb-lg-3 px-sm-0 px-md-3 px-lg-3 px-xl-3">
            <div class="d-flex justify-content-between align-items-baseline mt-3 mt-md-3 mt-lg-3 mt-xl-4">
                <h3 class="d-md-none d-lg-block pt-sm-2 pt-lg-3 text-left text-uppercase text_color">База знань</h3>
                ...
                <aside class="col-sm-12 col-lg-10 px-0 px-sm-0 pl-md-0 pl-lg-1 py-3 py-lg-0">
                    <div class="row mx-0 border border-primary rounded">
                        ...
                        <div class="col-12 mx-0 px-0 text-center">
                            <h2 class="d-flex flex-row justify-content-center align-items-center flex-wrap text-uppercase px-1 py-3 mx-1 my-1 text-white bg_headers">
                                Навчання - База знань</h2>
                        </div>
                        <!-- study-list -->
                        <div class="col-12 mx-0 px-1">
                            <div class="row w-100 mx-0 mt-0 mb-1 border border-secondary study_bg">
                                <div class="col-12 mx-0 px-0 text-center">
                                    <h3 class="d-flex flex-row justify-content-center align-items-center flex-wrap text-uppercase font-weight-bolder px-1 py-2 mx-1 my-1">
