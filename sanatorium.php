...
<title>Портал-Санаторій-профілакторій</title>
</head>
    ...
    <section class="mt-0 pt-3">
        <div class="container pt-2 pb-2 pb-lg-3 px-sm-0 px-md-3 px-lg-3 px-xl-3">
            <div class="d-flex justify-content-between align-items-baseline mt-3 mt-md-3 mt-lg-3 mt-xl-4">
                <h3 class="d-md-none d-lg-block pt-sm-2 pt-lg-3 text-left text-uppercase text_color">Санаторій-профілакторій</h3>
                <h3
            ...
            <div class="row pb-sm-1 ml-0 px-0 mr-0 mb-lg-5">
                ...
                <aside class="col-sm-12 col-lg-10 px-0 px-sm-0 pl-md-0 pl-lg-1 py-3 py-lg-0">
                    <div id="study-part-medical" class="row mx-0 border border-primary rounded">
                        <!-- heading -->
                        <div class="col-12 mx-0 px-0 text-center">
                            <h2
                                ...
                                Санаторій-профілакторій АТ "МГЗК" </h2>
                        </div>
                        <!-- description -->
                        <div class="row mx-1 mb-1 pt-3 bg_sanatorium">
                            <div class="col-12 mx-0 px-3">
                                <p class="lead text-justify">
                                    Санаторій-профілакторій функціонує з 1 квітня 1980 року. 
                                    У санаторії-профілакторії є багата лікувальна база.</p>
                                <p class="lead text-justify">Проводяться такі види лікування: <br><span class="font-weight-bold"><em>бальнеотерапія</em>, <em>гідротерапія</em>, <em>фітотерапія</em>, <em>фізіолікування</em>, 
                                    <em>інгаляції</em>, <em>електрогрязелікування</em>, <em>лікувальна фізкультура</em>, <em>масаж</em>, <em>парафіно-озокеритолікування</em>, <em>медикаментозне лікування</em></span>.</p>
                                <p class="lead text-justify">Санаторій-профілакторій функціонують такі лікувальні відділення:<br> 
                                    - <span class="font-weight-bold">два ванних відділення</span>, де відпускаються кисневі, перлинні, йодо-бромні, хвойні, 
                                    морські, хлоридно-натрієві, скипідарні, сірководневі ванни, гальванічні ванни, гідромасаж рук;<br> 
                                    - <span class="font-weight-bold">лікувальні душі</span>: циркулярний, висхідний, душ Шарко;<br>
                                    - <span class="font-weight-bold">парафіно - озокерітові аплікації</span>;<br>
                                    - <span class="font-weight-bold">фізіотерапевтичний кабінет</span> оснащений апаратурою:  УВЧ-66,  ЛОР -1, «Ампліпульс», 
                                    «Ультразвук», «Іскра», «Промінь-3»,  апарат для гальванізації, опромінювач  «Тубус-кварц», 
                                    стаціонарна кварцова установка УЧ -11,4 гальванічні апарати для відпустку гальвано-грязей, міоритм.</p>
                                <p class="lead text-justify">Також в оздоровниці знаходяться дві ванни для підводного душу-масажу, інгаляторій на 5 
                                     точок, масажний кабінет, кабінети штучного мікроклімату:<br><span class="font-weight-bold"> спелеотерапії і фіто&shy;аероіонотерапія, 
                                     зал для лікувальної фізкультури, процедурний кабінет, де проводиться медикаментозне лікування і фітотерапія відварами трав</span>.
                                    Санаторій-профілакторій АТ «Марганецький ГЗК» є потужною лікувальною базою для лікування 
                                    захворювань <span class="font-italic font-weight-bold">кістково-м΄язової системи, периферійної нервової системи, бронхо-легеневої та серцево-судинної 
                                    систем</span>, які стоять на першому місці в структурі захворюваності серед працівників комбінату.
                                </p>
                            </div>
                        </div>
                        <!-- gallary-list -->
